...
@TypeAlias("Lieferant")
@JsonPropertyOrder(
    "nachname", "telefonnummer", "email", "kategorie", "newsletter", "geburtsdatum",
...
data class Lieferant(
    ...
    @get:NotEmpty(message = "{lieferant.telefonnummer.notEmpty}")
    @get:Pattern(
        regexp = TELEFONNUMMER_PATTERN,
        message = "{lieferant.telefonnummer.pattern}")
    @Indexed
     ...
     */
    override fun toString() = "Lieferant(id=$id, version=$version, nachname=$nachname, telefonnummer=$telefonnummer, email=$email, " +
    ...
    companion object {
        ...
        private const val TELEFONNUMMER_PATTERN = "^011(9[976]\\d|8[987530]\\d|6[987]\\d|5[90]\\d|42\\d|3[875]\\d|\n" +
